...
def create_test_team_composition(
    name: str = "Test Team", game_mode: GameMode = GameMode.ZERG, team_size: int = 10, **kwargs
) -> TeamComposition:
    """
...
def create_test_team_slot(slot_number: int = 1, build: Optional[Build] = None, priority: int = 1, **kwargs) -> TeamSlot:
    """
...
def create_test_team_with_builds(
    name: str = "Test Team", game_mode: GameMode = GameMode.ZERG, num_builds: int = 5, **kwargs
) -> TeamComposition:
    """
    ...
    """
    team = create_test_team_composition(name=name, game_mode=game_mode, team_size=num_builds, **kwargs)
