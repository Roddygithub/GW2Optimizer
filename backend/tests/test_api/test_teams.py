...
class TestTeamAPI:
    ...
    async def test_create_team_authenticated(
        self, client: AsyncClient, auth_headers: dict, sample_team_data: dict
    ):
    ...
    async def test_create_team_with_builds(
        ...
        # Create builds first
        build1_response = await client.post(
            "/api/v1/builds",
        ...
        build2_response = await client.post(
            "/api/v1/builds",
            json=sample_build_data,
            headers=auth_headers
        )
    ...
    async def test_list_public_teams(
    ...
    async def test_add_build_to_team(
        ...
        # Add build to team
        response = await client.post(
            f"/api/v1/teams/{team_id}/builds/{build_id}",
            headers=auth_headers
        )
    ...
    async def test_remove_build_from_team(
        ...
        response = await client.delete(
            f"/api/v1/teams/{team_id}/slots/{slot_id}",
            headers=auth_headers
        )
    ...
    async def test_team_with_public_and_private_builds(
        ...
        public_build_response = await client.post(
            "/api/v1/builds",
            json=sample_build_data,
            headers=auth_headers
        )
        ...
        private_build_response = await client.post(
            "/api/v1/builds",
            json=sample_build_data,
            headers=auth_headers
        )
