...
class TestBuildAPI:
    ...
    async def test_create_build_authenticated(
    ...
    async def test_create_build_invalid_data(
    ...
    async def test_get_build_by_id(
        self, client: AsyncClient, auth_headers: dict, sample_build_data: dict
    ):
    ...
    async def test_list_builds_with_profession_filter(
        ...
        # Filter by Guardian
        response = await client.get(
            "/api/v1/builds?profession=Guardian",
            headers=auth_headers
        )
    ...
    async def test_list_public_builds(
        self, client: AsyncClient, sample_build_data: dict, auth_headers: dict
    ):
    ...
    async def test_get_build_stats(
        self, client: AsyncClient, auth_headers: dict, sample_build_data: dict
    ):
