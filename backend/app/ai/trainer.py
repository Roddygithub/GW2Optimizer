...
class AITrainer:
    ...
    def __init__(
        self,
        model: Optional[SynergyModel] = None,
    ...
    def train_batch(
        ...
        logger.info(
            ...
            extra={"min_rating": min_rating, "max_samples": max_samples}
        )
        
        start_time = datetime.utcnow()
        
        # Charger training data
        training_data = self.feedback_handler.get_training_data(
    ...
    def save_checkpoint(self, metrics: Optional[Dict[str, Any]] = None) -> str:
        ...
        logger.info(
            "Checkpoint saved",
            extra={"checkpoint": checkpoint_name}
        )
