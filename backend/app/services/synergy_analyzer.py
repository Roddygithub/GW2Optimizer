...
class SynergyAnalyzer:
    ...
    BOON_PROVIDERS: Dict[Profession, List[BoonType]] = {
        Profession.GUARDIAN: [
            BoonType.AEGIS, BoonType.PROTECTION, BoonType.STABILITY,
            BoonType.QUICKNESS, BoonType.MIGHT, BoonType.FURY
        ],
        Profession.REVENANT: [
            BoonType.ALACRITY, BoonType.MIGHT, BoonType.PROTECTION,
            BoonType.FURY, BoonType.STABILITY
        ],
        Profession.WARRIOR: [
            BoonType.MIGHT, BoonType.FURY, BoonType.VIGOR
        ],
        Profession.ENGINEER: [
            BoonType.QUICKNESS, BoonType.ALACRITY, BoonType.MIGHT,
            BoonType.FURY, BoonType.PROTECTION
        ],
        Profession.RANGER: [
            BoonType.MIGHT, BoonType.FURY, BoonType.REGENERATION,
            BoonType.SWIFTNESS, BoonType.ALACRITY
        ],
        Profession.THIEF: [
            BoonType.MIGHT, BoonType.FURY, BoonType.VIGOR
        ],
        Profession.ELEMENTALIST: [
            BoonType.MIGHT, BoonType.FURY, BoonType.PROTECTION,
            BoonType.REGENERATION, BoonType.SWIFTNESS
        ],
        Profession.MESMER: [
            BoonType.QUICKNESS, BoonType.ALACRITY, BoonType.MIGHT,
            BoonType.FURY, BoonType.AEGIS
        ],
    ...
    def _evaluate_role_effectiveness(self, build: Build) -> float:
        ...
        if build.role == Role.SUPPORT and build.profession in [
            Profession.GUARDIAN, Profession.ENGINEER, Profession.RANGER
        ]:
            score += 2.0
        elif build.role == Role.DPS and build.profession in [
            Profession.WARRIOR, Profession.THIEF, Profession.ELEMENTALIST
        ]:
            score += 2.0
        elif build.role == Role.TANK and build.profession in [
            Profession.GUARDIAN, Profession.WARRIOR
        ]:
            score += 2.0
    ...
    def _score_boon_coverage(self, team: TeamComposition) -> float:
        ...
        critical_boons = [BoonType.QUICKNESS, BoonType.ALACRITY, BoonType.MIGHT, 
                         BoonType.FURY, BoonType.PROTECTION, BoonType.STABILITY]
