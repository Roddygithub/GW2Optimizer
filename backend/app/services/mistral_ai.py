...
class MistralAIService:
    ...
    def _create_composition_prompt(self, wvw_data: Dict[str, Any], team_size: int, game_mode: str) -> str:
...
"""
    ...
    def _parse_ai_response(self, content: str, team_size: int, game_mode: str) -> Dict[str, Any]:
    ...
    def _generate_fallback_composition(self, team_size: int, game_mode: str) -> Dict[str, Any]:
