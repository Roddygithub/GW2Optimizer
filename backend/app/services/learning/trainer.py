...
class ModelTrainer:
    ...
    async def prepare_training_data(
        ...
        try:
            ...
            logger.info(
                f"Prepared {len(training_samples)} training samples in {output_file}"
            )
    ...
    async def _datapoint_to_training_sample(
        ...
        try:
            ...
            if datapoint.team_id:
                ...
                instruction = f"""Create a {datapoint.profession} {datapoint.role} build for {datapoint.game_mode} WvW."""
