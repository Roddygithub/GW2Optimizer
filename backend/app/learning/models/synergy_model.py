...
class SynergyModel:
    ...
    # Boons principaux
    BOONS = [
        "Might", "Fury", "Quickness", "Alacrity", "Stability",
        "Aegis", "Protection", "Resistance", "Regeneration", "Swiftness"
    ]
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        self.model_path = model_path or str(
            Path(settings.LEARNING_DATA_DIR) / "models" / "synergy_model.pkl"
        )
        self.scaler_path = str(
            Path(settings.LEARNING_DATA_DIR) / "models" / "synergy_scaler.pkl"
        )
        self.metadata_path = str(
            Path(settings.LEARNING_DATA_DIR) / "models" / "synergy_metadata.json"
        )
    ...
    def update(self, feedback: Dict[str, Any]) -> None:
        ...
        logger.info(
            "Model updated (incremental)",
            extra={"n_updates": self.metadata["n_updates"]}
        )
