...
async def create_build(
    ...
    try:
        ...
        try:
            ...
            await collector.collect_build_creation(
                build_db.__dict__,
        ...
        raise HTTPException(
            ...
            detail=f"Error creating build: {str(e)}"
        )
...
async def get_build(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error fetching build: {str(e)}"
        )
...
async def list_public_builds(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error listing public builds: {str(e)}"
        )
...
async def update_build(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error updating build: {str(e)}"
        )
...
async def get_build_count(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error counting builds: {str(e)}"
        )
